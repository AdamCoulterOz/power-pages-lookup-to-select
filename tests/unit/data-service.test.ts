    ...
    describe('createPolymorphicDataFunction', () => {
        ...
        it.skip('should handle errors from any entity fetch', async () => {
            ...
            return new Promise<void>((resolve, reject) => {
                dataFunction('test', () => {
                    reject(new Error('Success handler should not be called'));
                }, (error: any) => {
                    try {
