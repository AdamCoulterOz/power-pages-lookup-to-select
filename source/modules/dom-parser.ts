...
function parseViewLayouts(base64Data: string): pp.ViewLayout[] | null {
    try {
...
async function fetchFullViewLayouts(viewLayoutReferences: pp.ViewLayout[], lookupModal: JQuery<HTMLElement>): Promise<pp.CompleteViewLayout[]> {
...
function getEntityFormViewEntityName() : string | null
{
...
function getFirstFieldName(columns: pp.Column[]): string | null {
